		...
		<div>
			<Navbar bg="dark" variant="dark">
				...
				<Nav style={{alignItems:'center'}} className="align-middle">
					<Nav.Item style={{color:'white'}} href='#'><i className="fa fa-envelope fa-fw"></i></Nav.Item>
					<NavDropdown style={{allignSelf:'left'}} className="dropdown-menu-right" bg="light" title="">
